...
| `Theme`      | `#!luau Theme`                         | **[Read-only]** Inherited theme from the calling component.                                                                                             |
| `Structures` | `#!luau {[string]: Instance or {any}}` | **[Read-only]** Table of defined component structures.                                                                                                  |
